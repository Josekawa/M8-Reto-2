---
title: "Dashboard — Confianza y Prioridades Sociales (CRONOS2 Wave 4)"
output: 
...
### Distribución de género (Hombre, Mujer, NS/NC)
```{r}
renderPlotly({
  datos <- df
  if (input$pais != "Todos") datos <- dplyr::filter(datos, cntry == input$pais)
